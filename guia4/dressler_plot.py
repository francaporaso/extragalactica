...
ax[1].plot(df['log_den'], df['frac_ell'], ls='-', marker='o', markersize=4, c="#FF1F2A", label='E')
ax[1].plot(df['log_den'], df['frac_s0'], ls='-', marker='s', markersize=4, c="#00CD44", label='S0')
ax[1].plot(df['log_den'], df['frac_spir'], ls='-', marker='^', markersize=4, c="#007ADE", label='S+Irr')
